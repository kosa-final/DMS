...
def convert(file, zip=True):
    ...
    image_path = r"C:\Dev_2a\final_project\dataset\randomsplit\test\images" + '\\' + image_name
    save_dir = Path(r"C:\Dev_2a\final_project\dataset\randomsplit\test\labels")
...
if __name__ == '__main__':
    json_dir = Path(r"C:\Dev_2a\final_project\dataset\randomsplit\test\json")
